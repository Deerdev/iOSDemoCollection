...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation {
    NSLog(@"加载成功");
    NSLog(@"------------------------------------ ");
    NSString *js = @"var newscript = document.createElement(\"script\");";
    js = [js stringByAppendingString:@"newscript.type = \"text/javascript\";"];
    NSString *urlStr = [[NSBundle mainBundle] pathForResource:@"test.js" ofType:nil];
    js = [js stringByAppendingString:[NSString stringWithFormat:@"newscript.src=\"%@\";",urlStr]];
//    js = [js stringByAppendingString:@"newscript.src=\"http://ocaum8qny.bkt.clouddn.com/test.js\";"];
    js = [js stringByAppendingString:@"document.body.appendChild(newscript);"];
